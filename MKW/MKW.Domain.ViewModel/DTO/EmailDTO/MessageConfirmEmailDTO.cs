...
namespace MKW.Domain.Dto.DTO.EmailDTO
{
    ...
    {
        public MessageConfirmEmailDTO(IEnumerable<string> sendToList, string subject, string keycode)
        {
                        ...
                        $"<tr>" +
                            $"<td bgcolor=\"#ffffff\" align=\"center\" style=\"padding: 40px 0;\">" +
                                $"<h1 style=\"font-size: 40px; font-weight: bold; margin: 0; color: #016FB9;\">" +
                                    $"Obrigado por se cadastrar no MyKidsWatch!<br> </h1>" +
                            $"</td>" +
                        $"</tr>" +
                        $"<tr>" +
                            $"<td bgcolor=\"#ffffff\" align=\"center\" style=\"padding: 20px 0;\">" +
                                $"<div style=\"max-width: 400px; margin: 0 auto;\">" +
                                    $"<div style=\"background-color: #016FB9; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.7); padding: 20px;\">" +
                                        $"<h2 style=\"font-size: 24px; font-weight: bold; margin: 0; color: #ffffff;\">Ative sua Conta</h2>" +
                                        $"<p style=\"font-size: 18px; margin: 20px 0; color: #ffffff;\">Utilize o código de ativação abaixo para ativar sua conta:</p>" +

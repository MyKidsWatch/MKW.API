            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<int>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 11111,
                            ConcurrencyStamp = "a812344c-d578-4be2-a332-494adb103d64",
                            Name = "admin",
                        ...
                        {
                            Id = 11112,
                            ConcurrencyStamp = "545669fa-27c2-466e-9c93-bdda81ca0e39",
                            Name = "standard",
            ...
            modelBuilder.Entity("MKW.Domain.Entities.ContentAggregate.Platform", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreateDate = new DateTime(2023, 10, 28, 23, 54, 41, 974, DateTimeKind.Local).AddTicks(4120),
                            Name = "TMDb",
                            UUID = new Guid("7ae43548-6a26-49cf-9b63-24fedf7f15ce"),
                        ...
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreateDate = new DateTime(2023, 10, 28, 23, 54, 41, 974, DateTimeKind.Local).AddTicks(4131),
                            Name = "YouTube",
                            UUID = new Guid("3e33c08a-2a66-49fc-9cb6-79b24ef11c1e"),
                        ...
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreateDate = new DateTime(2023, 10, 28, 23, 54, 41, 974, DateTimeKind.Local).AddTicks(4133),
                            Name = "TikTok",
                            UUID = new Guid("a42d6cd1-e8b4-44cd-bd1e-ada8d770a224"),
                            Url = ""
                        });
                });
            ...
            modelBuilder.Entity("MKW.Domain.Entities.ContentAggregate.PlatformCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreateDate = new DateTime(2023, 10, 28, 23, 54, 41, 974, DateTimeKind.Local).AddTicks(6513),
                            Name = "Filme",
                            PlatformId = 1,
                            UUID = new Guid("42d90c51-329e-42b5-a150-26d5df4ba73a")
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreateDate = new DateTime(2023, 10, 28, 23, 54, 41, 974, DateTimeKind.Local).AddTicks(6532),
                            Name = "Filme",
                            PlatformId = 2,
                            UUID = new Guid("8117782c-24ac-4890-9c33-a1422accc853")
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreateDate = new DateTime(2023, 10, 28, 23, 54, 41, 974, DateTimeKind.Local).AddTicks(6534),
                            Name = "Perfil",
                            PlatformId = 3,
                            UUID = new Guid("8455de8d-9c07-4e5c-bb30-1ec3ce5123df")
                        });
                });
            ...
            modelBuilder.Entity("MKW.Domain.Entities.IdentityAggregate.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Active = true,
                            ConcurrencyStamp = "c9094b6c-52db-4b67-979c-8e30ca9ab440",
                            CreateDate = new DateTime(2023, 10, 28, 23, 54, 41, 959, DateTimeKind.Local).AddTicks(2624),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEFeHMBELOo+9FR13dNLfQwDu7i6UsHQODC7vBYrgxkIZU6tsnl0iN2UbsZgRb/E26w==",
                            PhoneNumber = "5511978019550",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "d535407c-2d40-430a-83f7-52d1fbf0b193",
            ...
            modelBuilder.Entity("MKW.Domain.Entities.ReportAggregate.ReportReason", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreateDate = new DateTime(2023, 10, 28, 23, 54, 41, 975, DateTimeKind.Local).AddTicks(9867),
                            ...
                            Title = "Hate Speech",
                            UUID = new Guid("420eaa36-f854-417a-bcec-cf7f6235666d")
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreateDate = new DateTime(2023, 10, 28, 23, 54, 41, 975, DateTimeKind.Local).AddTicks(9874),
                            Description = "Aggressive pressure or intimidation against an individual or group.",
                            Title = "Harassment",
                            UUID = new Guid("09cd561a-27a5-4227-810b-6e9133628f72")
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreateDate = new DateTime(2023, 10, 28, 23, 54, 41, 975, DateTimeKind.Local).AddTicks(9876),
                            ...
                            UUID = new Guid("de8111f2-f000-4d73-9281-e6f8bcfa658c")
                        },
                        new
                        {
                            Id = 4,
                            Active = true,
                            CreateDate = new DateTime(2023, 10, 28, 23, 54, 41, 975, DateTimeKind.Local).AddTicks(9878),
                            Description = "Other reasons. Please provide more information.",
                            Title = "Others",
                            UUID = new Guid("bd229e03-ce76-41a5-8085-a0bbcf17f48d")
                        });
                });
            ...
            modelBuilder.Entity("MKW.Domain.Entities.ReportAggregate.ReportStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreateDate = new DateTime(2023, 10, 28, 23, 54, 41, 976, DateTimeKind.Local).AddTicks(1649),
                            Name = "Análise Pendente",
                            UUID = new Guid("cea9bacd-3de0-4e6a-8d3b-2e85a7a9cc05")
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreateDate = new DateTime(2023, 10, 28, 23, 54, 41, 976, DateTimeKind.Local).AddTicks(1653),
                            Name = "Analisado",
                            UUID = new Guid("0d8c5b54-cfff-4029-b337-1281774a990c")
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreateDate = new DateTime(2023, 10, 28, 23, 54, 41, 976, DateTimeKind.Local).AddTicks(1665),
                            Name = "Descartado",
                            UUID = new Guid("0f0ffaa8-8e83-4361-9baa-19be92ffd869")
                        });
                });
            ...
            modelBuilder.Entity("MKW.Domain.Entities.UserAggregate.Gender", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            AlterDate = new DateTime(2023, 10, 28, 23, 54, 41, 969, DateTimeKind.Local).AddTicks(7113),
                            CreateDate = new DateTime(2023, 10, 28, 23, 54, 41, 969, DateTimeKind.Local).AddTicks(7104),
                            IsBinary = true,
                            Name = "Masculino",
                            UUID = new Guid("ad6306b7-35e6-49c2-aee0-70faa08e581c")
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            AlterDate = new DateTime(2023, 10, 28, 23, 54, 41, 969, DateTimeKind.Local).AddTicks(7127),
                            CreateDate = new DateTime(2023, 10, 28, 23, 54, 41, 969, DateTimeKind.Local).AddTicks(7125),
                            IsBinary = true,
                            Name = "Feminino",
                            UUID = new Guid("2b5180f6-81ce-4f77-929c-98afdc41f809")
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            AlterDate = new DateTime(2023, 10, 28, 23, 54, 41, 969, DateTimeKind.Local).AddTicks(7130),
                            CreateDate = new DateTime(2023, 10, 28, 23, 54, 41, 969, DateTimeKind.Local).AddTicks(7129),
                            IsBinary = false,
                            Name = "Não Binário",
                            UUID = new Guid("c982587b-ed02-43f7-b89a-0153206e3247")
                        });
                });

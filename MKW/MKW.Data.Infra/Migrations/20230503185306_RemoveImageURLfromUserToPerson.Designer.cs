...
namespace MKW.Data.Context.Migrations
{
    ...
    [Migration("20230503185306_RemoveImageURLfromUserToPerson")]
    partial class RemoveImageURLfromUserToPerson
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MKW.Domain.Entities.Identity.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MKW.Domain.Entities.UserAggregate.Person", b =>
                {
                    ...
                    b.HasOne("MKW.Domain.Entities.Identity.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("MKW.Domain.Entities.Identity.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

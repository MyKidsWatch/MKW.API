...
namespace MKW.Domain.Interface.Services.AppServices
{
    public interface IReportService
    {
        ...
        Task<BaseResponseDTO<ReportDto>> GetReports(int page = 1, int pageSize = 10, int? reasonId = null, int? statusId = null, string orderBy = "CreateDate", bool orderByAscending = true);
        ...
        Task<BaseResponseDTO<ReportStatusDto>> GetStatus();
    }
}
